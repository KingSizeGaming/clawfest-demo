...
function formatCurrency(value, options) {
    ...
    if (options && options.code) {
        ...
        var config = __assign$7({ useGrouping: true }, getFractionConfig(value, trimFraction));
...
function formatNumber(value, locale, trimFraction) {
    if (trimFraction === void 0) { trimFraction = false; }
    var fractionConfig = getFractionConfig(value, trimFraction);
    if (locale)
        locale = replaceUnderscoreWithDash(locale);
    return value.toLocaleString(locale, __assign$7({ style: 'decimal', useGrouping: true }, fractionConfig));
}
...
var RgsMultiAdapter = (function (_super) {
    __extends$d(RgsMultiAdapter, _super);
    function RgsMultiAdapter(config, RgsAdapterClass) {
        ...
        if (_this.metaGameId) {
            _this.metaRgs = new RgsAdapterClass(__assign$6(__assign$6({}, config), { gameId: _this.metaGameId }));
        ...
        var _loop_1 = function (gameId) {
            var rgs = new RgsAdapterClass(__assign$6(__assign$6({}, config), { gameId: gameId }));
    ...
    RgsMultiAdapter.prototype.getLimits = function () {
        var adapter = this.metaRgs || this.activeAdapter;
        return __assign$6(__assign$6({}, adapter.getLimits()), { subgames: this.getSubgameOptions() });
    };
...
var SimpleFlowAdapter = (function (_super) {
    __extends$c(SimpleFlowAdapter, _super);
    ...
    SimpleFlowAdapter.prototype.spin = function () {
        ...
        return getMessagesHandled()
            ...
            .catch(function (reason) { return _this.tryRetryPurchase(reason, tryCount$1, args); })
            .then(function (data) {
            tryCount$1 = 0;
...
var SimpleFlowRgs = (function (_super) {
    __extends$c(SimpleFlowRgs, _super);
...
var SlotAdapter = (function (_super) {
    __extends$b(SlotAdapter, _super);
    ...
    SlotAdapter.prototype.getLimits = function () {
        return __assign$5(__assign$5({}, _super.prototype.getLimits.call(this)), { lines: this.getLineOptions() });
    };
...
var SlotRgs = (function (_super) {
    ...
    function SlotRgs(config) {
        ...
        _this = _super.call(this, __assign$5(__assign$5({}, config), { gameService: service })) || this;
        return _this;
    }
...
var ScratchAdapter = (function (_super) {
    __extends$a(ScratchAdapter, _super);
    ...
    ScratchAdapter.prototype.purchaseTicket = function (bet) {
        ...
        return getMessagesHandled()
            ...
            .catch(function (reason) { return _this.tryRetryPurchase(reason, tryCount, [bet]); })
            .then(function (data) {
            tryCount = 0;
    ...
    ScratchAdapter.prototype.settleTicket = function (ticketId) {
        ...
        var rgsSettlePromise = this.rgs.settleTicket(ticketId)
            ...
            .then(function (data) { return __awaiter$3(_this, void 0, void 0, function () {
...
var ScratchcardRgs = (function (_super) {
    __extends$a(ScratchcardRgs, _super);
    function ScratchcardRgs(config) {
        return _super.call(this, __assign$4(__assign$4({}, config), { gameService: 'GameService' })) || this;
    }
...
var DefaultIntegrationLogic = (function (_super) {
    __extends$9(DefaultIntegrationLogic, _super);
    function DefaultIntegrationLogic() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.unsettledTicketExists = false;
        _this.lastShownBonusId = null;
        _this.isUsingBonus = false;
        _this.currentTotalBetDivider = 1;
        _this.allowedTotalBets = [];
        return _this;
    }
    ...
    DefaultIntegrationLogic.prototype.setUnsettledTicketExists = function (ticketExists) {
    ...
    DefaultIntegrationLogic.prototype.formatCurrency = function (value, trimFraction, currencyCode) {
        ...
        var formatCurrencyOptions = __assign$3(__assign$3({}, currency), { trimFraction: trimFraction, display: this.config.currencyDisplay, isSocialCasinoMode: this.config.isSocialCasinoMode, useCompactNotation: this.config.useCompactNotation });
        return formatCurrency(value, formatCurrencyOptions);
    };
    DefaultIntegrationLogic.prototype.formatNumber = function (value, trimFraction) {
        var locale = this.wrapperParams.language;
        return formatNumber(value, locale, trimFraction);
    };
    ...
    DefaultIntegrationLogic.prototype.handleNewRequest = function (host, data) {
        return __awaiter$2(this, void 0, void 0, function () {
    ...
    DefaultIntegrationLogic.prototype.addBonusHeader = function (xmlHttp) {
    ...
    DefaultIntegrationLogic.prototype.intializeRgsConfigParams = function () {
        return __awaiter$2(this, void 0, void 0, function () {
            var bonusGameId, bonusRoundsAdapter, slotRgs_1, error_1;
            var _this = this;
            return __generator$2(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 5, , 6]);
                        bonusGameId = void 0;
                        bonusRoundsAdapter = void 0;
                        if (this.gameWrapper.rgs instanceof RgsMultiAdapter) {
                            bonusGameId = this.gameWrapper.rgs.bonusRoundsGameId;
                            bonusRoundsAdapter = this.gameWrapper.rgs.game(bonusGameId);
                            this.bonusRoundsRgs = bonusRoundsAdapter.rgs;
                        }
                        else {
                            bonusRoundsAdapter = this.gameWrapper.rgs;
                            this.bonusRoundsRgs = bonusRoundsAdapter.rgs;
                            bonusGameId = this.bonusRoundsRgs.gameId;
                        }
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4:
                        this.allowedTotalBets = this.calculateTotalBets();
                        return [3, 6];
                    case 5:
                        error_1 = _a.sent();
    ...
    DefaultIntegrationLogic.prototype.findActiveBonus = function (bonuses) {
        var _this = this;
        var _a, _b;
        var now = Date.now();
    ...
    DefaultIntegrationLogic.prototype.handleBonusRounds = function () {
        var _this = this;
        try {
            var bonusGameId = void 0;
            var bonusRoundsAdapter = void 0;
            if (this.gameWrapper.rgs instanceof RgsMultiAdapter) {
                bonusGameId = this.gameWrapper.rgs.bonusRoundsGameId;
                bonusRoundsAdapter = this.gameWrapper.rgs.game(bonusGameId);
                this.bonusRoundsRgs = bonusRoundsAdapter.rgs;
            ...
            var allowedTotalBets = this.bonusInfo.betLevel;
            if (!allowedTotalBets) {
                console.log('gromada-gamewrpper: Bet level does not exists!');
                return;
            }
            var availableLimits_1;
            this.betLevel = Array.isArray(allowedTotalBets) ? allowedTotalBets[0] : allowedTotalBets;
            allowedTotalBets = this.calculateBetLevel(allowedTotalBets, this.currentTotalBetDivider);
            if (this.isBetAvailable(bonusRoundsAdapter, allowedTotalBets)) {
                availableLimits_1 = this.getLimitsForBet(bonusRoundsAdapter, allowedTotalBets);
            }
            else {
                console.error('gromada-gamewrapper: Bet level is not allowed for bonus rounds ', allowedTotalBets);
                this.gameWrapper.dispatchEvent('bonus-rounds-disabled');
                return;
            }
            if (!availableLimits_1) {
                console.error('gromada-gamewrapper: Invalid bet level supplied in Bonus data!');
                this.gameWrapper.dispatchEvent('bonus-rounds-disabled');
                return;
            }
            var startUsingBonus_1 = function () {
                _this.isUsingBonus = true;
                _this.gameWrapper.setBet(_this.betLevel);
                _this.gameWrapper.setBetStops(availableLimits_1);
                _this.gameWrapper.autoplay.setEnabled(false);
                _this.gameWrapper.ui.ready.then(function () {
                    var _a;
                    if (_this.lastShownBonusId != _this.bonusInfo.id) {
                        if (_this.bonusInfo.remainingRounds == _this.bonusInfo.totalRounds) {
                            var message = "";
                            if (_this.bonusInfo.endDateTime) {
                                var locale = _this.locale ? _this.locale : _this.wrapperParams.language;
                                var formatted = new Date(_this.bonusInfo.endDateTime).toLocaleDateString(locale);
                                message = Strings.BONUS_USE_BEFORE + " " + formatted;
                            }
                            if (_this.bonusInfo.totalRounds == _this.bonusInfo.remainingRounds) {
                                _this.gameWrapper.ui.showMessage({
                                    title: Strings.BONUS_STARTED,
                                    text: message
                                });
                            }
                            ;
                            _this.lastShownBonusId = _this.bonusInfo.id;
                        }
                        else if (_this.bonusInfo.remainingRounds && _this.bonusInfo.remainingRounds > 0) {
                            var message = Strings.BONUS_REMAINING_ROUNDS + ": " + _this.bonusInfo.remainingRounds + "/" + _this.bonusInfo.totalRounds;
                            _this.gameWrapper.ui.showMessage({
                                title: Strings.BONUS_BACK,
                                text: message
                            });
                        }
                        ...
                        if (_this.bonusInfo.remainingRounds) {
    ...
    DefaultIntegrationLogic.prototype.calculateBetLevel = function (totalBets, totalBetDivider) {
    ...
    DefaultIntegrationLogic.prototype.calculateTotalBets = function () {
        var _this = this;
        var stakeOptions = this.gameWrapper.rgs.getStakeOptions();
        this.currentTotalBetDivider;
        return stakeOptions.map(function (x) { return x * _this.currentTotalBetDivider; });
    };
    DefaultIntegrationLogic.prototype.finishBonusOffer = function (reason) {
        var _this = this;
    ...
    DefaultIntegrationLogic.prototype.isBetAvailable = function (rgs, bet) {
        var _this = this;
        if (rgs instanceof RgsMultiAdapter) {
            ...
            if (typeof bet === 'number') {
                var stake = bet;
                return rgs.getStakeOptions().indexOf(stake) > -1;
            }
            else {
                return bet.map(function (stake) { return _this.isBetAvailable(rgs, stake); }).reduce(function (acc, cur) { return acc && cur; }, true);
            }
        }
    };
    DefaultIntegrationLogic.prototype.getLimitsForBet = function (rgs, bet) {
        var bets = Array.isArray(bet) ? bet : [bet];
        if (rgs instanceof RgsMultiAdapter) {
            ...
            if (rgs.is(SlotAdapter)) {
                ...
                if (lineOptions.length > 0) {
                    var maxLines = Math.max.apply(Math, lineOptions);
    ...
    DefaultIntegrationLogic.prototype.setEventHandlers = function () {
        ...
        this.gameWrapper.initialized.then(function () {
            ...
            _this.gameWrapper.rgs.on('account-data-received', function (_a) {
                var _b;
                ...
                _this.intializeRgsConfigParams().then(function () { return _this.findActiveBonus(bonus); });
            });
            _this.gameWrapper.rgs.once('game-data-received', function (_a) {
                var detail = _a.detail;
                if (_this.gameWrapper.rgs.is(SimpleFlowAdapter) && detail.game.nextAction !== 'spin') {
                    _this.setUnsettledTicketExists(true);
                }
            });
            _this.gameWrapper.rgs.once('unsettled-ticket-received', function () {
                _this.setUnsettledTicketExists(true);
            });
            _this.gameWrapper.rgs.on('spin-started', function () {
            ...
            _this.gameWrapper.on('game-end', function () {
                if (_this.isUsingBonus) {
                    if (!_this.bonusInfo.remainingRounds) {
            ...
            _this.gameWrapper.rgs.on('error', function (_a) {
                var _b;
                var detail = _a.detail;
                var reason = detail;
                if (_this.isUsingBonus) {
...
var DummyAdapter = (function (_super) {
    __extends$8(DummyAdapter, _super);
...
var KenoAdapter = (function (_super) {
    __extends$7(KenoAdapter, _super);
    ...
    KenoAdapter.prototype.getLimits = function () {
        return __assign$2(__assign$2({}, _super.prototype.getLimits.call(this)), { denominations: this.getDenominationOptions() });
    };
...
var KenoRgs = (function (_super) {
    ...
    function KenoRgs(config) {
        ...
        _this = _super.call(this, __assign$2(__assign$2({}, config), { gameService: service })) || this;
        return _this;
    }
...
var CardsAdapter = (function (_super) {
    __extends$6(CardsAdapter, _super);
...
var CardsRgs = (function (_super) {
    ...
    function CardsRgs(config) {
        ...
        _this = _super.call(this, __assign$1(__assign$1({}, config), { gameService: service })) || this;
        return _this;
    }
...
var VERSION = '5.9.1';
var BUILD_DATE = '2026-03-27T14:39:57Z';
var actions = {
    autoplay: Function,
    play: Function,
    turbo: Function,
...
var GameWrapper = (function (_super) {
    ...
    GameWrapper.prototype.applySetup = function (config) {
        var _this = this;
        this.config = config;
        var jurisdictionCode = params['jurisdiction'];
        if (jurisdictionCode) {
            ...
            fetch(versionedJurisdictionPathResourceUrl, {
                method: "GET",
                mode: "cors"
            })
                    ...
                    for (var jurisdictionElement in jurisdictionWrapperConfig) {
                        switch (jurisdictionElement) {
                            case "additional":
                                ...
                                if (jurisdictionWrapperConfigAdditional) {
                                    if (jurisdictionWrapperConfigAdditional['gameName'] == false || jurisdictionWrapperConfigAdditional['title'] == false) {
                                        _this.ui.showElementsTopBar(false, 'game-title');
                                    }
                                    ...
                                    for (var _i = 0, uiElements_1 = uiElements; _i < uiElements_1.length; _i++) {
                                        ...
                                        if (jurisdictionWrapperConfigAdditional[uiElement] !== undefined) {
                                            _this.ui.showElementsTopBar(jurisdictionWrapperConfigAdditional[uiElement], uiElement);
                                        }
                                    }
                                }
                                break;
                            case "ui":
                                    ...
                                    if (jurisdictionUiBottomBar) {
                                        if (_this.config) {
                                            ...
                                            for (var bottomBarOption in jurisdictionUiBottomBar) {
                                                ...
                                                _this.ui.showElementsBottomBar(jurisdictionUiBottomBar[bottomBarOption], bottomBarOption);
                                            }
                                        }
                                    }
                                    ...
                                    if (jurisdictionUiTopBar) {
                                        if (_this.config) {
                                            ...
                                            for (var topBarOption in jurisdictionUiTopBar) {
                                                ...
                                                _this.ui.showElementsTopBar(jurisdictionUiTopBar[topBarOption], topBarOption);
                                            }
                                        }
                                    }
                                }
                                break;
                            default:
                                if (_this.config && _this.config[jurisdictionElement]) {
        ...
        if (config.content) {
            ...
            if (isMobile && config.fullscreen !== false && !fullscreen) {
                var fsElement_1;
                ...
                if (config.fullscreenAfterLoad === false) {
                    fullscreen = new Fullscreen(fsElement_1, config.fullscreen);
                }
                else {
                    this.ui.ready.then(function () { return fullscreen = new Fullscreen(fsElement_1, config.fullscreen); });
                }
            }
        ...
        var simpleFlowUpdateBet = function (event) {
            if (event.detail) {
        ...
        this.rgs.on('spin-done', simpleFlowUpdateBet);
        this.rgs.on('free-spin-done', simpleFlowUpdateBet);
    ...
    GameWrapper.prototype.setBetStops = function (betConfig) {
        ...
        this.rgs.configured.then(function () { return _this.dispatchEvent('set-stake-limits', _this.rgs.getLimits()); });
    };
...
var MessageDialog = (function () {
    ...
    MessageDialog.prototype.showInsufficientFunds = function (depositUrl) {
        ...
        var action = depositUrl
            ? { name: Strings.MESSAGE_DIALOG_ADD_FUNDS, action: function () { return _this.goToUrlHandler(depositUrl); } }
            : { name: Strings.OK, action: this.hide };
        return this.displayMessage(message, action);
    };
...
var WrapperUI = (function (_super) {
    ...
    WrapperUI.prototype.changeSoundStatus = function (soundOn) {
        if (soundOn) {
            ...
            this.bottomBarSoundButton.classList.remove('gw-btn-sfx-off');
            this.topBarSoundButton.classList.remove('gw-btn-sfx-off');
        }
        else {
            this.dispatchEvent('sound-mute');
            this.bottomBarSoundButton.classList.add('gw-btn-sfx-off');
            this.topBarSoundButton.classList.add('gw-btn-sfx-off');
        }
    ...
    WrapperUI.prototype.setupBottomBar = function (config) {
        ...
        this.demoShowsModeOnly = config.demoShowsModeOnly;
    ...
    WrapperUI.prototype.attachRgs = function (rgs, params) {
        ...
        rgs.on('game-data-received', function (event) { return wrapperReady.then(function () {
            if (rgs.is(SimpleFlowAdapter) && event.detail.game.nextAction !== 'spin') {
...
export { BUILD_DATE, MAX_PURCHASE_ATTEMPTS, VERSION, actions, GameWrapper as default, fullscreen, getApiSelector, getParam, params, setApiSelector };
